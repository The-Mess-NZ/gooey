...
// Command represents a message sent from the host (Midipunk) to Gooey.
type Command struct {
...
// Event represents a message generated by Gooey and sent to the host.
type Event struct {
...
// NewServer creates a new IPC Server for Gooey.
